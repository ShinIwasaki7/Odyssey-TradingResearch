...
| D08 | [テスト戦略](D08_test_strategy.md)（v0.1 起草 2026-09-22、承認待ち） | 第8.4節を具体化。段階1〜2 で実際に書かれたテスト資産を正本に、テストの7層・意味論テスト一覧（契約行との対応表）・人工データ生成仕様・golden の運用・決定論の検証・CI の並びを定める | D06 | 段階1〜 |
