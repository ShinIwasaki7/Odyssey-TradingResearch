...
| D06 | [バックテストエンジン設計](D06_backtest_vertical_slice.md)（v1.0 承認 2026-09-21、PR #16、段階2 の最小縦断範囲） | 第5.4節・第7.4節。フェーズ順序、4型全フィールド、状態機械、理由コード、trace/result 形式 | D02〜D05 | 段階0〜2 |
