...
|---|---|---|---|
| 1 | 宣言型の構造 | 3クラスと補助型のフィールド・不変条件・区分、正規化、設定ファイル表現（第3節・第3.1節・第4〜11節・第13.1節） | ―（本書で完結する） |
