...
作成日: 2026-09-21
状態: **v2.7（2026-09-25、段階3 完了の文書 PR）。段階3 範囲の Q10〜Q30 はすべて決定済み（承認待ち）**（第15節）。段階3 実装 PR 2/5（コンパイラ）・PR 3/5（ランタイム前半）・PR 4/5（ランタイム後半）・PR 5/5（エンジン＋受入）が仮置きした点への人間の決定（2026-09-24・2026-09-25）を反映した。段階2 で承認済みの範囲（**承認（2026-09-21、PR #15）**、v1.0〜v1.4）は本改訂で変えていない。
...
| **v2.4**（2026-09-24、PR #27） | 検証戦略 B の評価順についての**人間の再決定**の反映（第3節の型表・第5.4節・第7.7節・第9.2節）。取引機会の参照の因果辺 `OPPORTUNITY_CONTEXT` を足し、その辺を含めた規則の出力を第9.2節末尾の評価順とした | 承認待ち（PR #27） |
...
| v2.8 以降 | 第10.2節が段階4 以降へ送った項目 | 未起草 |
