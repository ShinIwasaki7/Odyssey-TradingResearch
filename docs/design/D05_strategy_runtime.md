...
| 【提案】 | 本書が推奨する設計。承認で確定 |
| 【要決定】 | 承認時にユーザーが選択する事項。段階2 の Q1〜Q9 は **2026-09-21 に決定済み**（第13節）、段階3 の Q10〜Q18 は **2026-09-22 に**、Q19〜Q22 は **2026-09-23 に決定済み**（第15節）。**ただし紙上トレース [T02](../traces/T02_paper_trace_strategy_b.md) が立てた Q23〜Q29 は未決である**（第15.3節）。決まるまで、その7件が指す箇所の実装は始められない |
